...
const getAllAdmins = (paginationOptions, filtersOptions) => __awaiter(void 0, void 0, void 0, function* () {
    // Pagination Options
    ...
    const whereCondition = Object.keys(andConditions).length
        ? { $and: andConditions }
        : {};
    const facultiesData = yield admin_model_1.default.find(whereCondition)
...
const getAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield admin_model_1.default.findById(id).populate('managementDepartment').exec();
    return data;
});
const updateAdmin = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = yield admin_model_1.default.findOneAndUpdate({ id }, adminData, {
        new: true,
    })
        .populate('managementDepartment')
        .exec();
