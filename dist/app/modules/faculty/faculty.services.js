...
const getAllFacultys = (paginationOptions, filtersOptions) => __awaiter(void 0, void 0, void 0, function* () {
    // Pagination Options
    ...
    const whereCondition = Object.keys(andConditions).length
        ? { $and: andConditions }
        : {};
    const facultiesData = yield faculty_model_1.default.find(whereCondition)
        .populate('academicDepartment academicFaculty')
        .sort(sortCondition)
        .skip(skip)
        .limit(limit)
        .exec();
    const totalDoc = yield faculty_model_1.default.countDocuments(whereCondition);
    return {
        meta: {
            page,
            limit,
...
const getFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield faculty_model_1.default.findById(id)
        .populate('academicDepartment academicFaculty')
        .exec();
    return data;
});
const updateFaculty = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const { name } = payload, facultyData = __rest(payload
    ...
    const data = yield faculty_model_1.default.findOneAndUpdate({ id }, facultyData, {
        new: true,
    })
        .populate('academicDepartment academicFaculty')
        .exec();
