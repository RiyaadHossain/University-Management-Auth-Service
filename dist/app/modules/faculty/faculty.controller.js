...
const getAllFacultys = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield faculty_services_1.FacultyService.getAllFacultys(
      paginationOptions,
      filterOptions
    )
...
const updateFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield faculty_services_1.FacultyService.updateFaculty(
      id,
      facultyData
    )
    ;(0, sendResponse_1.default)(res, {
