...
const getAllFaculties = (paginationOptions, filtersOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Pagination Options
    ...
    const whereCondition = Object.keys(andConditions).length
      ? { $and: andConditions }
      : {}
    const facultiesData = yield academicFaculty_model_1.default
      .find(whereCondition)
      .sort(sortCondition)
      .skip(skip)
      .limit(limit)
...
const updateFaculty = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = yield academicFaculty_model_1.default.findOneAndUpdate(
      { _id: id },
      payload,
      {
        new: true,
