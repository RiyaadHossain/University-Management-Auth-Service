...
router.patch('/:id', (0, validateRequest_1.validateRequest)(student_validation_1.StudentValidaion.updateStudentZodSchema), student_controller_1.StudentController.updateStudent);
