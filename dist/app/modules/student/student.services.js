...
const getAllStudents = (paginationOptions, filtersOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const whereCondition = Object.keys(andConditions).length
      ? { $and: andConditions }
      : {}
    const facultiesData = yield student_model_1.default
      .find(whereCondition)
      ...
      .limit(limit)
      .exec()
    const totalDoc = yield student_model_1.default.countDocuments(
      whereCondition
    )
    return {
      meta: {
...
const getStudent = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = yield student_model_1.default
      .findById(id)
      .populate('academicSemester academicDepartment academicFaculty')
      .exec()
    return data
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (guardian && Object.keys(guardian).length > 0) {
      Object.keys(guardian).forEach(key => {
        ...
        studentData[guardianKey] = guardian[key]
      })
    }
    // 3. localGuardian
    if (localGuardian && Object.keys(localGuardian).length > 0) {
      Object.keys(localGuardian).forEach(key => {
        ...
        studentData[localGuardianKey] = localGuardian[key]
      })
    }
    const data = yield student_model_1.default
      .findOneAndUpdate({ id }, studentData, {
        new: true,
      })
      .populate('academicSemester academicDepartment academicFaculty')
      .exec()
