...
const academicSemester_model_1 = __importDefault(
  require('../academicSemester/academicSemester.model')
)
...
const createStudent = (student, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const academicSemester = yield academicSemester_model_1.default.findById(
    ...
    try {
      ...
      user.id = id
      // Create Student Doc
      const newStudent = yield student_model_1.default.create([student], {
        session,
      })
    ...
    if (userAllData) {
      userAllData = yield user_model_1.default
        .findById(userAllData._id)
        .populate({
          path: 'student',
          populate: [
...
const createFaculty = (faculty, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      user.id = id
      // Create Faculty Doc
      const newFaculty = yield faculty_model_1.default.create([faculty], {
        session,
      })
...
const createAdmin = (admin, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (!user.password) user.password = config_1.default.UNIVERSITY_ADMIN_PASS
      // Create User Doc
      const newUser = yield user_model_1.default.create([user], { session })
      userAllData = newUser[0]
      if (!newUser.length)
