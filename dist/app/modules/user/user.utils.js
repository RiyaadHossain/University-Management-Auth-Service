...
const lastStudent = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_model_1.default
      .findOne({ role: user_1.ENUM_USER_ROLE.STUDENT }, { id: 1, _id: 0 })
      .sort({
        createdAt: -1,
      })
    return (_a = user === null || user === void 0 ? void 0 : user.id) ===
      null || _a === void 0
      ? void 0
      : _a.substring(4)
  })
...
const lastFaculty = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _c
    const user = yield user_model_1.default
      .findOne({ role: user_1.ENUM_USER_ROLE.FACULTY }, { id: 1, _id: 0 })
      .sort({
        createdAt: -1,
      })
    if (!user) return null
    return (_c = user === null || user === void 0 ? void 0 : user.id) ===
      null || _c === void 0
      ? void 0
      : _c.substring(2)
  })
...
const lastAdmin = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.default
      .findOne({ role: user_1.ENUM_USER_ROLE.ADMIN }, { id: 1, _id: 0 })
      .sort({
        createdAt: -1,
      })
    if (!user) return null
