...
const createSemesterEvent = async (payload: ICreateAcademicSemesterEvent) => {
  const { title, year, code, startMonth, endMonth, id } = payload
...
const updateSemesterEvent = async (payload: ICreateAcademicSemesterEvent) => {
  const { title, year, code, startMonth, endMonth, id } = payload
...
const deleteSemesterEvent = async (payload: ICreateAcademicSemesterEvent) => {
  const { id } = payload

  await AcademicSemester.deleteOne({ syncId: id })
}
